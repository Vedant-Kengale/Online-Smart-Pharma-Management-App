					...
					<div class="col-md-6">
						<div class="row mb-5">
							<div class="col-md-6 mb-3 mb-md-0">
								<button class="btn btn-primary btn-md btn-block">Update
									Cart</button>
							</div>
							<div class="col-md-6">
						...
						<div class="row">
							...
							<div class="col-md-4">
								<button class="btn btn-primary btn-md px-4">Apply
									Coupon</button>
							</div>
						</div>
					</div>
							...
							<div class="col-md-7">
								...
								<div class="row mb-3">
									...
									<div class="col-md-6 text-right">
										Rs. <strong class="text-black" id="stotal"></strong>
									</div>
								</div>
								<div class="row mb-5">
									<div class="col-md-6">
									...
									<div class="col-md-6 text-right">
										Rs. <strong class="text-black" id="total"></strong>
									</div>
								</div>
				...
				<div class="row">
					<div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
						...
						<div class="block-7">
							...
							<p>A digital pharma management platform focused on efficient
								medicine ordering, inventory control, and customer handling.
								Online Pharma Management System is a JSP-based web application
								built to deliver secure operations, improved accuracy, and a
								smooth user experience for pharmacies and users.</p>
						</div>
					...
					<div class="col-lg-3 mx-auto mb-5 mb-lg-0">
						...
						<ul class="list-unstyled">
							<li><a href="mailto:vedantkengale96@gmail.com"
								aria-label="Gmail">Gmail</a></li>
							<li><a href="https://linkedin.com/in/vedant-kengale"
								aria-label="LinkedIn">LinkedIn</a></li>
							<li><a href="https://github.com/Vedant-Kengale"
								aria-label="Github">Github</a></li>
							<li><a href="https://www.instagram.com/vedant_kengale_5126/"
					...
					<div class="col-md-6 col-lg-3">
						<div class="block-5 mb-5">
							...
							<ul class="list-unstyled">
								...
								<li class="phone"><a href="tel://919284875613">+91
										92848 75613</a></li>
				...
				<div class="row pt-5 mt-5 text-center">
					<div class="col-md-12">
						<p>
							...
							All rights reserved | Made <i aria-hidden="true"></i> by <a
								href="https://my_portfolio.com" target="_blank"
								class="text-primary">Vedant Kengale</a>
